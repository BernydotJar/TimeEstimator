...
const handleOverheadChange = (e: React.ChangeEvent<HTMLInputElement>, key: string) => {
...
<CardTitle style={{ color: neonTextColors[0] }}>Overhead Configuration</CardTitle>

<CardDescription style={{ color: neonTextColors[1] }}>Configure overhead percentages.</CardDescription>
...
<Label htmlFor="releaseConfig">Release and Configuration Guide (%)</Label>
...
<TableCell>{activities.reduce((sum, activity) => sum + Number(activity.effort), 0).toFixed(2)}</TableCell>
...
<p style={{ color: neonTextColors[1] }}><strong>Total Core Effort:</strong> {(() => {
...
<li key={type} style={{ color: neonTextColors[index % neonTextColors.length] }}>{type} {effort.toFixed(2)} hours</li>

))}

</ul>

<p style={{ color: neonTextColors[0] }}><strong>Contingency ({overheadPercentages.contingency * 100}%):</strong> {contingencyEffort.toFixed(2)} hours</p>

<p style={{ color: neonTextColors[1] }}><strong>Project Management ({overheadPercentages.pm * 100}%):</strong> {pmEffort.toFixed(2)} hours</p>

<p style={{ color: neonTextColors[0] }}><strong>Solution Architect ({overheadPercentages.sa * 100}%):</strong> {saEffort.toFixed(2)} hours</p>

<p style={{ color: neonTextColors[1] }}><strong>SDD ({overheadPercentages.sdd * 100}%):</strong> {sddEffort.toFixed(2)} hours</p>

<p style={{ color: neonTextColors[0] }}><strong>Release and Configuration Guide ({overheadPercentages.releaseConfig * 100}%):</strong> {releaseConfigEffort.toFixed(2)} hours</p>

<p style={{ color: neonTextColors[1] }}><strong>User Manual ({overheadPercentages.userManual * 100}%):</strong> {userManualEffort.toFixed(2)} hours</p>
