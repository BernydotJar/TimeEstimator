  ...
  return (
    <Dialog open={open} onOpenChange={handleOpen}>
      <DialogTrigger asChild>
        <Button className="cinematic-button-secondary" variant="outline" size="sm" aria-label="Overhead configuration">
          <Settings className="h-3.5 w-3.5 sm:mr-1.5" />
          <span className="hidden sm:inline">Overhead</span>
        </Button>
      </DialogTrigger>
      <DialogContent className="border-white/10 bg-slate-950 text-slate-100 sm:max-w-[520px]">
        <DialogHeader>
