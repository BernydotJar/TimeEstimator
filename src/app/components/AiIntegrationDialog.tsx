  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogTrigger asChild>
        <Button className="cinematic-button-secondary" variant="outline" size="sm" aria-label="AI Integrations">
          <PlugZap className="h-3.5 w-3.5 sm:mr-1.5" />
          <span className="hidden sm:inline">AI Integrations</span>
        </Button>
      </DialogTrigger>
      <DialogContent className="max-h-[88vh] overflow-y-auto border-white/10 bg-slate-950 text-slate-100 sm:max-w-[760px]">
        <DialogHeader>
